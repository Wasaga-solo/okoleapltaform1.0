...
<form action = "suggestionHandle.php" method = "POST" name = "uploadsform" enctype = "multipart/form-data" id = "upload-form" onsubmit = "return validate()">
	<ul>
		<li>What kind of file do you want to suggest? <select name = "file_type" class = "info">
		...
		<li>Which school is this suggestion intended for?<select class = "info" name = "school" onchange = "decideOptions(this.options[this.selectedIndex].value);">
		...
		<li>Which course is the suggestion intended for?<select name = "course" id = "courses" class = "info"><option value = "">Select a school first</option></select></li>
		...
		<li><button type = "submit" name = "submit" id = "press2" class = "form_send">Suggest</button></li>
	</ul>
</form>
<script>
	//dynamic dropdown
