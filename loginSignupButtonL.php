<button id = "signup" style = "background-color:maroon; color: white; border-radius : 0px 20px 0px 140px">Sign up</button>
<button id = "login"  name = "submitlog"  style = "background-color:rgba(245, 245, 245, 0.086); color: maroon; ">Log in</button>
